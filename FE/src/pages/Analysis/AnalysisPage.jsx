        ...
        <section className="card dashboard-empty-state analysis-empty-state">
          ...
          <div className="input-row analysis-empty-input">
            <input
              ...
              placeholder="Try: pho, electric bike, AI agent, TikTok Shop trends..."
            />
            <Button
              onClick={() => {
        ...
        <section className={`card research-guard-card ${canRunDeepInsight ? 'guard-ok' : 'guard-low'}`}>
          ...
          <div className="grid grid-2">
            <div className="opportunity-item">
              ...
              <p className="hint">
                {canRunDeepInsight
                  ? 'Keyword này có thể dùng cho deep insight.'
                  : 'Cần tinh chỉnh keyword trước khi đưa ra quyết định lớn.'}
              </p>
            </div>
            <div className="opportunity-item">
