    ...
    <div className="stack page-wrap">
      <section className="hero card">
        <h1 className="hero-title">
          Nhận định Thị trường trong vài <span className="highlight">Giây</span>, Không phải vài Tuần
        </h1>
        <p className="hero-subtitle">
          Hệ thống phân tích thị trường và phát hiện tín hiệu thời gian thực giúp bạn đưa ra quyết định kinh doanh thông minh hơn ngay lập tức.
        </p>
        ...
        <div className="input-row">
          <input
            ...
            placeholder="Nhập từ khóa thị trường hoặc dán liên kết sản phẩm..."
          />
        ...
        <p className="hint">Thử tìm: Xe máy điện, Xu hướng TikTok Shop, hoặc liên kết sản phẩm Shopee</p>
      </section>
          ...
          {visibleTrends.map((trend) => (
            ...
            >
              <div className="trend-card-top">
                <span className="trend-badge">Xu hướng nóng</span>
