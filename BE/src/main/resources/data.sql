...
VALUES
    ...
    ('STARTER', 0.20, 100, 10, '100 searches/month, basic insight, export PDF', CURRENT_TIMESTAMP),
    ('TEAM', 0.40, 500, 100, '500 searches/month, advanced insight, competitor view, priority processing', CURRENT_TIMESTAMP),
